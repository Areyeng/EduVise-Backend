...
{
    public abstract class EduViseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EduViseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EduViseWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<EduViseDbContext> action)
        {
            using (var context = IocManager.Resolve<EduViseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<EduViseDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<EduViseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EduViseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EduViseDbContext, Task<T>> func)
        {
            T result;
